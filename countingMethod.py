...
# Form implementation generated from reading ui file 'cuntingMethod.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(568, 411)
        self.scrollArea = QtWidgets.QScrollArea(Dialog)
        self.scrollArea.setGeometry(QtCore.QRect(20, 80, 541, 41))
        ...
        self.label.setGeometry(QtCore.QRect(220, 0, 111, 16))
        self.label.setObjectName("label")
        self.label_9 = QtWidgets.QLabel(Dialog)
        self.label_9.setGeometry(QtCore.QRect(20, 130, 231, 16))
        self.label_9.setObjectName("label_9")
        self.scrollArea_6 = QtWidgets.QScrollArea(Dialog)
        self.scrollArea_6.setGeometry(QtCore.QRect(20, 160, 541, 51))
        self.scrollArea_6.setWidgetResizable(True)
        self.scrollArea_6.setObjectName("scrollArea_6")
        self.scrollAreaWidgetContents_6 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 539, 49))
        ...
        self.label_5.setGeometry(QtCore.QRect(20, 230, 421, 16))
        self.label_5.setObjectName("label_5")
        self.scrollArea_2 = QtWidgets.QScrollArea(Dialog)
        self.scrollArea_2.setGeometry(QtCore.QRect(20, 260, 541, 91))
        self.scrollArea_2.setWidgetResizable(True)
        self.scrollArea_2.setObjectName("scrollArea_2")
        self.scrollAreaWidgetContents_2 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 539, 89))
        self.scrollAreaWidgetContents_2.setObjectName("scrollAreaWidgetContents_2")
        self.scrollArea_3 = QtWidgets.QScrollArea(self.scrollAreaWidgetContents_2)
        self.scrollArea_3.setGeometry(QtCore.QRect(10, 30, 181, 41))
        self.scrollArea_3.setWidgetResizable(True)
        self.scrollArea_3.setObjectName("scrollArea_3")
        self.scrollAreaWidgetContents_3 = QtWidgets.QWidget()
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 179, 39))
        self.scrollAreaWidgetContents_3.setObjectName("scrollAreaWidgetContents_3")
        self.label_7 = QtWidgets.QLabel(self.scrollAreaWidgetContents_3)
        self.label_7.setGeometry(QtCore.QRect(0, 10, 181, 31))
        self.label_7.setText("")
        self.label_7.setPixmap(QtGui.QPixmap("расчетный метод111.PNG"))
        ...
        self.label_10.setGeometry(QtCore.QRect(210, 10, 141, 16))
        self.label_10.setObjectName("label_10")
        self.label_13 = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        self.label_13.setGeometry(QtCore.QRect(360, 10, 171, 20))
        self.label_13.setObjectName("label_13")
        self.scrollArea_13 = QtWidgets.QScrollArea(self.scrollAreaWidgetContents_2)
        self.scrollArea_13.setGeometry(QtCore.QRect(210, 30, 141, 41))
        ...
        self.label_12.setGeometry(QtCore.QRect(80, 10, 21, 16))
        ...
        self.scrollArea_14.setGeometry(QtCore.QRect(360, 30, 161, 41))
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(220, 30, 231, 22))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "Электроэнергетика"))
        ...
        self.label_4.setText(_translate("Dialog", "Электроподстанции"))
        ...
        self.pushButton.setText(_translate("Dialog", "Выбор"))
